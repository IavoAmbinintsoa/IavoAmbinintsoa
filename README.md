Avant toute installation, commençons par installer les outils de base nécessaires à la compilation de logiciels sur un système Linux en utilisant la commande suivante :
